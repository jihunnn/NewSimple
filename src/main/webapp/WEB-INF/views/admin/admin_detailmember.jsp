	...
	<section class="ftco-section testimony-section"
		...
		<div class="container">
			...
			<section class="ftco-section testimony-section"
				...
				<div class="container">
					<div
						style="font-size: 20px; font-weight: bold; margin-left: 18px; padding-top: 19px; text-align:center; margin-right:498px;">
						<a style="color: #7e9c8c;">회원정보수정</a>
					</div>
					<section class="Easy-sgin-in-wrap4">
						<div id="LeftBox" style="font-size: 13px;">
							<form name="Checkmodify"
								action="${contextPath}/admin/modMember.do" method="post">
								<table
									style="margin-top: 30px; margin-left: 35px; font-size: 13px;">
									<tr
										style="border-top: 1px solid #eeeeee; height: 60px; border-bottom: 1px solid #eeeeee;">
										<td
											style="width: 200px; text-align: center; background-color: #7e9c8c; color: white;">아이디</td>
										<td><input type="text" name="memId"
											value="${member.memId}"
											style="font-size: 13px; margin-left: 10px; border: 1px solid #dcdcdc; width: 316px; height: 36px; color: #b3b3b3;"
											readonly>
									</tr>
									<tr style="border-bottom: 1px solid #eeeeee;">
										<td
											style="height: 60px; text-align: center; background-color: #7e9c8c; color: white;">이름</td>
										<td><input type="text" name="memName"
											value="${member.memName}"
											style="font-size: 13px; margin-left: 10px; border: 1px solid #dcdcdc; width: 316px; height: 36px;">
									</tr>
									<tr style="border-bottom: 1px solid #eeeeee;">
										<td
											style="height: 60px; width: 200px; text-align: center; background-color: #7e9c8c; color: white;">이메일</td>
										<td><input type="text" name="memEmail" placeholder=""
											value=<%=memEmail[0]%> size="20"
											style="font-size: 13px; margin-left: 10px; border: 1px solid #dcdcdc; width: 130px; height: 36px; margin-right: 5px;">
											@ <select name="memEmail1" id="selcet1"
											style="font-size: 13px; margin-left: 10px; border: 1px solid #dcdcdc; width: 153px; height: 36px; margin-right: 5px;">
									...
									<tr style="border-bottom: 1px solid #eeeeee;">
										<td
											style="height: 60px; width: 200px; text-align: center; background-color: #7e9c8c; color: white;">핸드폰</td>
										<td><select name="memPhoneNum"
											style="font-size: 14px; margin-left: 10px; border: 1px solid #dcdcdc; width: 87px; height: 36px; margin-right: 5px;">
											...
											value=<%=memPhoneNum[1]%> size="5"
											style="font-size: 13px; margin-right: 5px; margin-left: 5px; border: 1px solid #dcdcdc; width: 96px; height: 36px;">
									...
									<tr style="border-bottom: 1px solid #eeeeee;">
										<td
											style="height: 60px; width: 200px; text-align: center; background-color: #7e9c8c; color: white;">주소</td>
										<td colspan="3" class="addr" style="padding-left: 10px;">
											<input type="text" value="<%=memAdr[0]%>" name="memAdr"
											id="sample6_postcode" readonly size="15"
											style="font-size: 14px; margin-right: 5px; border: 1px solid #dcdcdc; width: 211px; height: 36px;">
									...
									<tr style="border-bottom: 1px solid #eeeeee;">
										<td
											style="height: 60px; width: 200px; text-align: center; background-color: #7e9c8c; color: white;">
											<div align="center" style="color: white;">상세주소</div>
										</td>
										<td colspan="3" class="addr1" style="padding-left: 10px;">
											<input type="text" name="memAdr1" id="sample6_address"
											size="40" value="<%=memAdr[1]%>"
											style="font-size: 13px; margin-top: 10px; border: 1px solid #dcdcdc; width: 316px; height: 36px;">
											<div style="padding-top: 10px;">
												<input type="text" id="sample6_address2" name="memAdr2"
													size="40" value="<%=memAdr[2]%>"
													style="font-size: 13px; margin-right: 5px; margin-bottom: 10px; border: 1px solid #dcdcdc; width: 316px; height: 36px;">
											</div>
										</td>
									...
									<tr style="border-bottom: 1px solid #eeeeee;">
										<td
											style="height: 60px; width: 200px; text-align: center; background-color: #7e9c8c; color: white;">회원유형</td>
									...
									<tr style="border-bottom: 1px solid #eeeeee;">
										<td
											style="height: 60px; width: 200px; text-align: center; background-color: #7e9c8c; color: white;">가입일</td>
						...
						<ul class="sign-button-list4">
							<li style="margin-left: 50px;">
								<button onclick="Check_Join()"
									style="background-color: #5f5f5f; cursor:pointer; font-size: 13px;  border:none; border-radius: 2px; width: 400px; float: left;">
									<i class="btn-Non Order Inquiry"></i><span style="color:white;">수정</span>
								</button>
							...
							<li style="margin-left: 50px;">
								<button
									...
									style="background-color: white; font-size: 13px; cursor:pointer; color: gray; border: 1px solid #eeeeee; border-radius: 2px; width: 400px; float: left;">
