											...
											<c:forEach var="mypageReviewList" items="${mypageReviewList}">
												...
												<tr style="height: 120px; background-color: white;">
													...
													<th colspan="2"
														...
														<div
															style="border: 1px solid #eeeeee; padding-left: 10px; background-color: #white; padding-top: 10px; padding-bottom: 10px; width: 600px; font-weight:normal;">${mypageReviewList.productContent}<br>
															<img id="preview"
